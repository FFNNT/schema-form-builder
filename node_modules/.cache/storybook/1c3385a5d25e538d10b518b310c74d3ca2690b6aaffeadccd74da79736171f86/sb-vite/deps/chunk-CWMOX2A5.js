...
var getAct = async () => {
  ...
  if (typeof clonedReact.act == "function") reactAct = clonedReact.act;
    ...
    let deprecatedTestUtils = await import("./test-utils-42GZYWB4.js");
...
var beforeAll = async () => {
  try {
    let { configure } = await import("./dist-X2XRVDZK.js"), act = await getAct();
...
//# sourceMappingURL=chunk-CWMOX2A5.js.map
